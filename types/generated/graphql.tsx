...
export type Mutation_Root = {
  ...
  /** delete data from the table: "pofile_users" */
  delete_pofile_users?: Maybe<Pofile_Users_Mutation_Response>;
  /** delete single row from the table: "pofile_users" */
  delete_pofile_users_by_pk?: Maybe<Pofile_Users>;
  ...
  /** insert data into the table: "pofile_users" */
  insert_pofile_users?: Maybe<Pofile_Users_Mutation_Response>;
  /** insert a single row into the table: "pofile_users" */
  insert_pofile_users_one?: Maybe<Pofile_Users>;
  ...
  /** update data of the table: "pofile_users" */
  update_pofile_users?: Maybe<Pofile_Users_Mutation_Response>;
  /** update single row of the table: "pofile_users" */
  update_pofile_users_by_pk?: Maybe<Pofile_Users>;
  /** update multiples rows of table: "pofile_users" */
  update_pofile_users_many?: Maybe<Array<Maybe<Pofile_Users_Mutation_Response>>>;
...
/** mutation root */
export type Mutation_RootDelete_Pofile_UsersArgs = {
  where: Pofile_Users_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Pofile_Users_By_PkArgs = {
  id: Scalars['uuid'];
};
...
/** mutation root */
export type Mutation_RootInsert_Pofile_UsersArgs = {
  objects: Array<Pofile_Users_Insert_Input>;
  on_conflict?: Maybe<Pofile_Users_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Pofile_Users_OneArgs = {
  object: Pofile_Users_Insert_Input;
  on_conflict?: Maybe<Pofile_Users_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Pofile_UsersArgs = {
  _set?: Maybe<Pofile_Users_Set_Input>;
  where: Pofile_Users_Bool_Exp;
};


/** mutation root */
export type Mutation_RootUpdate_Pofile_Users_By_PkArgs = {
  _set?: Maybe<Pofile_Users_Set_Input>;
  pk_columns: Pofile_Users_Pk_Columns_Input;
};


/** mutation root */
export type Mutation_RootUpdate_Pofile_Users_ManyArgs = {
  updates: Array<Pofile_Users_Updates>;
};
...
/** columns and relationships of "pofile_users" */
export type Pofile_Users = {
  __typename?: 'pofile_users';
  id: Scalars['uuid'];
...
/** aggregated selection of "pofile_users" */
export type Pofile_Users_Aggregate = {
  __typename?: 'pofile_users_aggregate';
  aggregate?: Maybe<Pofile_Users_Aggregate_Fields>;
  nodes: Array<Pofile_Users>;
};

export type Pofile_Users_Aggregate_Bool_Exp = {
  count?: Maybe<Pofile_Users_Aggregate_Bool_Exp_Count>;
};

export type Pofile_Users_Aggregate_Bool_Exp_Count = {
  arguments?: Maybe<Array<Pofile_Users_Select_Column>>;
  distinct?: Maybe<Scalars['Boolean']>;
  filter?: Maybe<Pofile_Users_Bool_Exp>;
  predicate: Int_Comparison_Exp;
};

/** aggregate fields of "pofile_users" */
export type Pofile_Users_Aggregate_Fields = {
  __typename?: 'pofile_users_aggregate_fields';
  count: Scalars['Int'];
  max?: Maybe<Pofile_Users_Max_Fields>;
  min?: Maybe<Pofile_Users_Min_Fields>;
};


/** aggregate fields of "pofile_users" */
export type Pofile_Users_Aggregate_FieldsCountArgs = {
  columns?: Maybe<Array<Pofile_Users_Select_Column>>;
  distinct?: Maybe<Scalars['Boolean']>;
};

/** order by aggregate values of table "pofile_users" */
export type Pofile_Users_Aggregate_Order_By = {
  count?: Maybe<Order_By>;
  max?: Maybe<Pofile_Users_Max_Order_By>;
  min?: Maybe<Pofile_Users_Min_Order_By>;
};

/** input type for inserting array relation for remote table "pofile_users" */
export type Pofile_Users_Arr_Rel_Insert_Input = {
  data: Array<Pofile_Users_Insert_Input>;
  /** upsert condition */
  on_conflict?: Maybe<Pofile_Users_On_Conflict>;
};

/** Boolean expression to filter rows from the table "pofile_users". All fields are combined with a logical 'AND'. */
export type Pofile_Users_Bool_Exp = {
  _and?: Maybe<Array<Pofile_Users_Bool_Exp>>;
  _not?: Maybe<Pofile_Users_Bool_Exp>;
  _or?: Maybe<Array<Pofile_Users_Bool_Exp>>;
  id?: Maybe<Uuid_Comparison_Exp>;
...
/** unique or primary key constraints on table "pofile_users" */
export enum Pofile_Users_Constraint {
  /** unique or primary key constraint on columns "id" */
  PofileUsersPkey = 'pofile_users_pkey'
}

/** input type for inserting data into table "pofile_users" */
export type Pofile_Users_Insert_Input = {
  id?: Maybe<Scalars['uuid']>;
...
/** aggregate max on columns */
export type Pofile_Users_Max_Fields = {
  __typename?: 'pofile_users_max_fields';
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by max() on columns of table "pofile_users" */
export type Pofile_Users_Max_Order_By = {
  id?: Maybe<Order_By>;
...
/** aggregate min on columns */
export type Pofile_Users_Min_Fields = {
  __typename?: 'pofile_users_min_fields';
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by min() on columns of table "pofile_users" */
export type Pofile_Users_Min_Order_By = {
  id?: Maybe<Order_By>;
  profile_id?: Maybe<Order_By>;
  user_id?: Maybe<Order_By>;
};

/** response of any mutation on the table "pofile_users" */
export type Pofile_Users_Mutation_Response = {
  __typename?: 'pofile_users_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Pofile_Users>;
};

/** on_conflict condition type for table "pofile_users" */
export type Pofile_Users_On_Conflict = {
  constraint: Pofile_Users_Constraint;
  update_columns?: Array<Pofile_Users_Update_Column>;
  where?: Maybe<Pofile_Users_Bool_Exp>;
};

/** Ordering options when selecting data from "pofile_users". */
export type Pofile_Users_Order_By = {
  id?: Maybe<Order_By>;
...
/** primary key columns input for table: pofile_users */
export type Pofile_Users_Pk_Columns_Input = {
  id: Scalars['uuid'];
};

/** select columns of table "pofile_users" */
export enum Pofile_Users_Select_Column {
  /** column name */
  Id = 'id',
  /** column name */
...
/** input type for updating data in table "pofile_users" */
export type Pofile_Users_Set_Input = {
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** Streaming cursor of the table "pofile_users" */
export type Pofile_Users_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Pofile_Users_Stream_Cursor_Value_Input;
  /** cursor ordering */
  ordering?: Maybe<Cursor_Ordering>;
};

/** Initial value of the column from where the streaming should start */
export type Pofile_Users_Stream_Cursor_Value_Input = {
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** update columns of table "pofile_users" */
export enum Pofile_Users_Update_Column {
  /** column name */
  Id = 'id',
  /** column name */
  ProfileId = 'profile_id',
...
export type Pofile_Users_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: Maybe<Pofile_Users_Set_Input>;
  /** filter the rows which have to be updated */
  where: Pofile_Users_Bool_Exp;
...
export type Profiles = {
  ...
  /** An array relationship */
  pofile_users: Array<Pofile_Users>;
  /** An aggregate relationship */
  pofile_users_aggregate: Pofile_Users_Aggregate;
  /** An object relationship */
  user?: Maybe<Users>;
};
...
/** columns and relationships of "profiles" */
export type ProfilesPofile_UsersArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
  where?: Maybe<Pofile_Users_Bool_Exp>;
};


/** columns and relationships of "profiles" */
export type ProfilesPofile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
export type Profiles_Bool_Exp = {
  ...
  pofile_users?: Maybe<Pofile_Users_Bool_Exp>;
  pofile_users_aggregate?: Maybe<Pofile_Users_Aggregate_Bool_Exp>;
  user?: Maybe<Users_Bool_Exp>;
};
...
export type Profiles_Insert_Input = {
  ...
  pofile_users?: Maybe<Pofile_Users_Arr_Rel_Insert_Input>;
  user?: Maybe<Users_Obj_Rel_Insert_Input>;
};
...
export type Profiles_Order_By = {
  ...
  pofile_users_aggregate?: Maybe<Pofile_Users_Aggregate_Order_By>;
  user?: Maybe<Users_Order_By>;
};
...
export type Query_Root = {
  ...
  /** An aggregate relationship */
  pofile_users_aggregate: Pofile_Users_Aggregate;
  /** fetch data from the table: "pofile_users" using primary key columns */
  pofile_users_by_pk?: Maybe<Pofile_Users>;
...
export type Query_RootPofile_UsersArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
export type Query_RootPofile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
export type Query_RootPofile_Users_By_PkArgs = {
  id: Scalars['uuid'];
};
...
export type Subscription_Root = {
  ...
  /** fetch data from the table: "pofile_users" using primary key columns */
  pofile_users_by_pk?: Maybe<Pofile_Users>;
  /** fetch data from the table in a streaming manner: "pofile_users" */
  pofile_users_stream: Array<Pofile_Users>;
  /** fetch data from the table: "profiles" */
  profiles: Array<Profiles>;
  /** fetch aggregated fields from the table: "profiles" */
  profiles_aggregate: Profiles_Aggregate;
...
export type Subscription_RootPofile_UsersArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
export type Subscription_RootPofile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
export type Subscription_RootPofile_Users_By_PkArgs = {
  id: Scalars['uuid'];
};


export type Subscription_RootPofile_Users_StreamArgs = {
  batch_size: Scalars['Int'];
  cursor: Array<Maybe<Pofile_Users_Stream_Cursor_Input>>;
  where?: Maybe<Pofile_Users_Bool_Exp>;
};
...
/** columns and relationships of "users" */
export type UsersPofile_UsersArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
/** columns and relationships of "users" */
export type UsersPofile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Pofile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Pofile_Users_Order_By>>;
...
export type UpdateUserMutation = { __typename?: 'mutation_root', delete_users_by_pk?: { __typename?: 'users', id: any, name: string, created_at: any } | null };
...
export function useGetUserIdsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetUserIdsQuery, GetUserIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetUserIdsQuery, GetUserIdsQueryVariables>(GetUserIdsDocument, options);
        }
...
export type GetUserIdsSuspenseQueryHookResult = ReturnType<typeof useGetUserIdsSuspenseQuery>;
